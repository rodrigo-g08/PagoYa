...
public class RecurringBillPaymentService implements IRecurringBillPaymentService {
    ...
    public RecurringBillPaymentResponse schedule(CreateRecurringBillPaymentRequest request) {
        ...
        // RN-R01: solo proveedores activos
        if (!provider.isActive()) {
            throw new InactiveProviderException();
        }

        // RN-R02 / RN-R03: validar dia segun la frecuencia
    ...
    public RecurringBillPaymentResponse resume(Long id) {
        ...
        // RN-R05: solo se puede reanudar uno PAUSED
        ...
        // recalcular proxima ejecucion al reanudar
    ...
    public void cancel(Long id) {
        ...
        // RN-R06: no se puede cancelar uno ya CANCELLED
    ...
    /**
     * Ejecuta UN pago recurrente que ya toca: crea el BillPayment
     * y avanza nextRunAt al proximo ciclo. Lo invoca el scheduler.
     */
    @Override
    @Transactional
